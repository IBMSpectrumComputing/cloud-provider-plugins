...
/**
* @ClassName: GcloudRequest
* @Description: The request from LSF host factory
* @author zcg
* @date Sep 11, 2017 3:29:08 PM
* @version 1.0
*/
public class GcloudRequest {
    /**
    ...
    /**
     * Type of host allocation: onDemand, bulk
     * Default is bulk
     */
    ...
    @JsonProperty("bulkInsertId")
    @JsonInclude(Include.NON_NULL)
    private String bulkInsertId;
    ...
    * @param machines
    */
    public void update(GcloudRequest req) {
    ...
    */
     ...
     *
     * @param bulkInsertId
     *            the bulkInsertId to set
     */
    public void setBulkInsertId(String bulkInsertId) {
        this.bulkInsertId = bulkInsertId;
    }
    ...
    */
    ...
    public String toString() {
        ...
        builder.append("GcloudRequest [reqId=");
