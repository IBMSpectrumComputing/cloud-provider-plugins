...
$_java $SCRIPT_OPTIONS -Dhome-dir=$homeDir -jar $homeDir/lib/ocTool.jar --getAvailableTemplates $homeDir $inJson

# getReturnRequests.sh is not called

#$_java $SCRIPT_OPTIONS -Daws-home-dir=$homeDir -jar $homeDir/lib/ocTool.jar --getRequestStatus $homeDir $inJson >/dev/null 2>&1;
