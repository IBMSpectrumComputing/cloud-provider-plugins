#!/bin/sh
# This script:
#    - should be called as getAvailableMachines.sh -f input.json
...
$_java $SCRIPT_OPTIONS -Daws-home-dir=$homeDir -jar $homeDir/lib/AwsTool.jar --getAvailableMachines $homeDir $inJson
